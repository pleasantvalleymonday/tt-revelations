...
CATEGORY_COMMUNITY_MANAGER = MagicWordCategory('Community manager', defaultAccess=150)
CATEGORY_MODERATOR = MagicWordCategory('Moderator', defaultAccess=200)
CATEGORY_CREATIVE = MagicWordCategory('Creative', defaultAccess=300)
CATEGORY_PROGRAMMER = MagicWordCategory('Programmer', defaultAccess=400)
CATEGORY_ADMINISTRATOR = MagicWordCategory('Administrator', defaultAccess=500)
CATEGORY_SYSTEM_ADMINISTRATOR = MagicWordCategory('System administrator', defaultAccess=600)
CATEGORY_FUCKING_OVERPOWERED = MagicWordCategory('Fucking Overpowered', defaultAccess=700)
