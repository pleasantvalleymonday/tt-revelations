...
CRBootedReasons = {100: 'You have been disconnected because someone else just logged in using your account on another computer.',
 ...
 105: 'Toontown Journey is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Toontown Journey website.',
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Toontown Journey Support if the problem persists.',
...
AsciiNotSupported = 'Sorry, but Toontown Journey does not support non-ASCII characters.'
AccessToString = {
